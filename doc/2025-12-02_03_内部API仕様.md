...
| メソッド | パス | 説明 |
|---------|------|------|
| GET | `/__snaperro__/patterns/:pattern/files` | 記録ファイル一覧取得 |
| GET | `/__snaperro__/patterns/:pattern/files/:filename` | 記録ファイル内容取得 |
| GET | `/__snaperro__/patterns/:pattern/files/:filename/download` | 記録ファイル個別ダウンロード |
| POST | `/__snaperro__/patterns/:pattern/files/upload` | 記録ファイルアップロード |
| PUT | `/__snaperro__/patterns/:pattern/files/:filename` | 記録ファイル編集 |
| DELETE | `/__snaperro__/patterns/:pattern/files/:filename` | 記録ファイル削除 |
...
| filesCount | number | 現在のパターン内の記録ファイル数 |
