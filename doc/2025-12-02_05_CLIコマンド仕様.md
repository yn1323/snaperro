...
2. `.snaperro/recordings/` ディレクトリを作成
...
🐕 snaperro server starting...
  ...
  Pattern: 正常系フル (restored from previous session)
...
サーバー起動時に `.snaperro/state.json` を読み込み、前回のモードとパターンを復元します。
