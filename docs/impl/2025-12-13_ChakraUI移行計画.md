...
| `client/src/components/ScenarioPane.tsx` | シナリオ名のはみ出し |
...
### 6.1 ScenarioMenu
**ファイル**: `client/src/components/ScenarioMenu.tsx`
**複雑度**: Medium
...
### 6.2 CreateScenarioModal
**ファイル**: `client/src/components/CreateScenarioModal.tsx`
**複雑度**: Medium
